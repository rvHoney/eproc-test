...
export default function Header() {
    return (
        <header className="flex flex-col items-center justify-center text-center p-4 max-w-3xl mx-auto mt-8 mb-16 gap-6">
            <h1 className="font-[family-name:var(--font-mabry)] text-2xl sm:text-4xl lg:text-5xl">
                Clothes <ImagePill bgImage='/images/pill-image.jpg' /> Make Your Skin Bright And Comfortable.
            </h1>
            <p className="font-[family-name:var(--font-inter)] max-w-lg">
